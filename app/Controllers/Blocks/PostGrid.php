...
class PostGrid
{
	...
	public function get_attributes()
	{
		$attributes = array(
			...
			"mainWrapMargin" => array(
				...
				'style'   => [
					(object) [
						'selector' => '{{RTRB}}.rtrb-block.rtrb-post-grid-wrapper{{mainWrapMargin}}'
					]
				]
			),
			"mainWrapPadding" => array(
				...
				'style'   => [
					(object) [
						'selector' => '{{RTRB}}.rtrb-block.rtrb-post-grid-wrapper{{mainWrapPadding}}'
					]
				]
			),
			...
			"mainWrapBG" => array(
				...
				'style' => [
					(object) [
						'selector' => '{{RTRB}}.rtrb-block.rtrb-post-grid-wrapper'
					]
				]
			),
			...
			"mainWrapHoverBG" => array(
				...
				'style' => [
					(object) [
						'selector' => '{{RTRB}}.rtrb-block.rtrb-post-grid-wrapper:hover'
					],
				]
			),
			...
			"mainWrapBGOverlay" => array(
				...
				'style' => [
					(object) [
						...
						'selector' => '{{RTRB}}.rtrb-block.rtrb-post-grid-wrapper::before'
					]
				]
			),
			...
			'mainWrapBorderStyle'   => array(
				...
				'style'   => [
					(object) [
						'selector' => '{{RTRB}}.rtrb-block.rtrb-post-grid-wrapper{border-style:{{mainWrapBorderStyle}};}'
					]
				]
			),
			...
			'mainWrapBorderColor'   => array(
				...
				'style'   => [
					(object) [
						'selector' => '{{RTRB}}.rtrb-block.rtrb-post-grid-wrapper{border-color:{{mainWrapBorderColor}};}'
					]
				]
			),
			...
			"mainWrapBorderWidth" => array(
				...
				'style'   => [
					(object) [
						'selector' => '{{RTRB}}.rtrb-block.rtrb-post-grid-wrapper{{mainWrapBorderWidth}}'
					]
				]
			),
			...
			"mainWrapRadius" => array(
				...
				'style'   => [
					(object) [
						'selector' => '{{RTRB}}.rtrb-block.rtrb-post-grid-wrapper{{mainWrapRadius}}'
					]
				]
			),
			...
			'mainWrapHoverBorderStyle'   => array(
				...
				'style'   => [
					(object) [
						'selector' => '{{RTRB}}.rtrb-block.rtrb-post-grid-wrapper:hover{border-style:{{mainWrapHoverBorderStyle}};}'
					]
				]
			),
			...
			'mainWrapHoverBorderColor'   => array(
				...
				'style'   => [
					(object) [
						'selector' => '{{RTRB}}.rtrb-block.rtrb-post-grid-wrapper:hover{border-color:{{mainWrapHoverBorderColor}};}'
					]
				]
			),
			...
			"mainWrapHoverBorderWidth" => array(
				...
				'style'   => [
					(object) [
						'selector' => '{{RTRB}}.rtrb-block.rtrb-post-grid-wrapper:hover{{mainWrapHoverBorderWidth}}'
					]
				]
			),
			...
			"mainWrapHoverRadius" => array(
				...
				'style'   => [
					(object) [
						'selector' => '{{RTRB}}.rtrb-block.rtrb-post-grid-wrapper:hover{{mainWrapHoverRadius}}'
					]
				]
			),
			...
			'mainWrapShadow' => [
				...
				'default' => (object)['openShadow' => 1, 'width' => (object)['top' => 1, 'right' => 1, 'bottom' => 1, 'left' => 1], 'color' => '', 'inset' => false, 'transition' => 0.5],
				'style' => [
					(object)['selector' => '{{RTRB}}.rtrb-block.rtrb-post-grid-wrapper']
				],
			],
			...
			'mainWrapHoverShadow' => [
				...
				'default' => (object)['openShadow' => 1, 'width' => (object)['top' => 1, 'right' => 1, 'bottom' => 1, 'left' => 1], 'color' => '', 'inset' => false, 'transition' => 0.5],
				'style' => [
					(object)['selector' => '{{RTRB}}.rtrb-block.rtrb-post-grid-wrapper:hover']
				],
			],
	...
	public function register_post_grid()
	{
		register_block_type(
			RTRB_PATH_BLOCKS . 'post-grid',
			[
	...
	public function render_block($settings)
	{
		...
		$data = [
			'template'              => 'blocks/post-grid/' . $layoutType . '/layout-' . $layout,
			'settings'              => $settings,
			'the_loops'				=> $the_loops,
