...
class LogoGrid
{
	...
	{
		if (Fns::rtrb_has_block('rtrb/logo-grid') && !is_admin()) {
	...
	public function get_attributes()
	{
		$attributes = [
			...
			'logoItemGap' => [
				...
				'style'   => [
					(object) [
						'selector' => '{{RTRB}}.rtrb-block .rtrb-logo-grid {gap: {{logoItemGap}}; }',
					],
				],
			],
			'logoColumn'  => [
				...
				'style'   => [
					(object) [
						'selector' => '{{RTRB}}.rtrb-block .rtrb-logo-grid {grid-template-columns: repeat({{logoColumn}}, 1fr); }',
					],
				],
			],
			...
			"mainWrapMargin" => array(
				...
				'style'   => [
					(object) [
						'selector' => '{{RTRB}}.rtrb-block .rtrb-logo-grid{{mainWrapMargin}}'
					]
				]
			),
			"mainWrapPadding" => array(
				...
				'style'   => [
					(object) [
						'selector' => '{{RTRB}}.rtrb-block .rtrb-logo-grid{{mainWrapPadding}}'
					]
				]
			),
			...
			"mainWrapBG" => array(
				...
				'style' => [
					(object) [
						'selector' => '{{RTRB}}.rtrb-block .rtrb-logo-grid'
					]
				]
			),
			...
			"mainWrapHoverBG" => array(
				...
				'style' => [
					(object) [
						'selector' => '{{RTRB}}.rtrb-block .rtrb-logo-grid:hover'
					],
				]
			),
			...
			"mainWrapBGOverlay" => array(
				...
				'style' => [
					(object) [
						...
						'selector' => '{{RTRB}}.rtrb-block .rtrb-logo-grid::before'
					]
				]
			),
			...
			'mainWrapBorderStyle'   => array(
				...
				'style'   => [
					(object) [
						'selector' => '{{RTRB}}.rtrb-block .rtrb-logo-grid{border-style:{{mainWrapBorderStyle}};}'
					]
				]
			),
			...
			'mainWrapBorderColor'   => array(
				...
				'style'   => [
					(object) [
						'selector' => '{{RTRB}}.rtrb-block .rtrb-logo-grid{border-color:{{mainWrapBorderColor}};}'
					]
				]
			),
			...
			"mainWrapBorderWidth" => array(
				...
				'style'   => [
					(object) [
						'selector' => '{{RTRB}}.rtrb-block .rtrb-logo-grid{{mainWrapBorderWidth}}'
					]
				]
			),
			...
			"mainWrapRadius" => array(
				...
				'style'   => [
					(object) [
						'selector' => '{{RTRB}}.rtrb-block .rtrb-logo-grid{{mainWrapRadius}}'
					]
				]
			),
			...
			'mainWrapHoverBorderStyle'   => array(
				...
				'style'   => [
					(object) [
						'selector' => '{{RTRB}}.rtrb-block .rtrb-logo-grid:hover{border-style:{{mainWrapHoverBorderStyle}};}'
					]
				]
			),
			...
			'mainWrapHoverBorderColor'   => array(
				...
				'style'   => [
					(object) [
						'selector' => '{{RTRB}}.rtrb-block .rtrb-logo-grid:hover{border-color:{{mainWrapHoverBorderColor}};}'
					]
				]
			),
			...
			"mainWrapHoverBorderWidth" => array(
				...
				'style'   => [
					(object) [
						'selector' => '{{RTRB}}.rtrb-block .rtrb-logo-grid:hover{{mainWrapHoverBorderWidth}}'
					]
				]
			),
			...
			"mainWrapHoverRadius" => array(
				...
				'style'   => [
					(object) [
						'selector' => '{{RTRB}}.rtrb-block .rtrb-logo-grid:hover{{mainWrapHoverRadius}}'
					]
				]
			),
			...
			'mainWrapShadow' => [
				...
				'default' => (object)['openShadow' => 1, 'width' => (object)['top' => 1, 'right' => 1, 'bottom' => 1, 'left' => 1], 'color' => '', 'inset' => false, 'transition' => 0.5],
				'style' => [
					(object)['selector' => '{{RTRB}}.rtrb-block .rtrb-logo-grid']
				],
			],
			...
			'mainWrapHoverShadow' => [
				...
				'default' => (object)['openShadow' => 1, 'width' => (object)['top' => 1, 'right' => 1, 'bottom' => 1, 'left' => 1], 'color' => '', 'inset' => false, 'transition' => 0.5],
				'style' => [
					(object)['selector' => '{{RTRB}}.rtrb-block .rtrb-logo-grid:hover']
				],
			],
	...
	public function render_block($settings)
	{
		$layout = '1';
		$data = [
			'template'              => 'blocks/logo-grid/layout-' . $layout,
			'settings'              => $settings,
