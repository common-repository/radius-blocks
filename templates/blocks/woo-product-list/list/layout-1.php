...
$wrap_class = 'rtrb-block rtrb-product-list-wrapper rtrb-block-frontend ';
...
if (isset($settings['postColumn'])) {
	$block_wrap_class .= ' rtrb-pcolumn-' . $settings['postColumn']['lg'];
}
...
<div class="<?php echo esc_attr($wrap_class); ?>">
	...
	<?php if ($settings['showPagination'] && !empty($the_loops['total_page'])) { ?>
