...
<div class="<?php echo esc_attr($wrap_class); ?>">
	<div class="rtrb-gradient-heading rtrb-gradient-heading--layout-<?php echo esc_attr($settings['layout']); ?>">
		...
		<?php if ($settings['subHeadingPosition'] == 'top' && $settings['displaySubheading'] && !empty($settings['subheadingText'])) : ?>
			<div class="rtrb-gradient-heading__sub-title-wrap">
				<div class="rtrb-gradient-heading__sub-title">
		...
		<div class="rtrb-gradient-heading__title-wrap">
			<?php echo '<' . esc_html($settings['tagName']) . ' class="rtrb-gradient-heading__title">'; ?>
		...
		<?php if ($settings['displayDescription'] && !empty($settings['descriptionText'])) : ?>
			<div class="rtrb-gradient-heading__desc-wrap">
				<p class="rtrb-gradient-heading__desc"><?php echo Fns::rtrb_kses_basic($settings['descriptionText']); ?></p>
			</div>
		<?php endif; ?>
