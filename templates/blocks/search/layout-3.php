...
<div class="<?php echo esc_attr($wrap_class); ?>">
	<div class="<?php echo esc_attr($block_wrap_class); ?>">
		...
		<a href="#" id="rtrb-search-icon3" class="rtrb-search-icon-btn" type="button">
		...
		<a href="#" id="rtrb-search-close-icon3" class="rtrb-search-close-btn" type="button">
			<span class="rtrb-search-icon">
				<svg width="1.5em" height="1.5em" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
					<path d="M310.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L160 210.7 54.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L114.7 256 9.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L160 301.3 265.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L205.3 256 310.6 150.6z" />
				</svg>
			</span>
		</a>

		<div class="header-search-field" id="rtrb-search-template3">
			<form class="rtrb-search-form" role="search" action="<?php echo site_url(); ?>" method="get">
				<input type="search" placeholder="<?php echo esc_attr($settings['placeholderText']); ?>" name="s" title="Search" class="rtrb-search-input" />
				<?php if ($settings['searchIconDisplay']) : ?>
					<button class="rtrb-search-btn" type="submit">
