					...
					<div class="rtrb-team__content">
						<?php if ($settings['socialIconDisplay'] && !empty($settings['socialIcons'])) : ?>
							<div class="rtrb-team__social-area">
								<ul class="radius-social-dropdown-layout radius-social-dropdown-layout--bottomToTop">
									<li>
										<a href="#">
										...
										<ul>
											<?php foreach ($settings['socialIcons'] as $socialicon) : ?>
												<?php if (!empty($socialicon['icon'])) : ?>
													<li>
														<a target="<?php echo esc_attr($social_target); ?>" rel="<?php echo esc_attr($social_nofollow); ?>" href="<?php echo esc_url($socialicon['url']); ?>">
